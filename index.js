...
app.get("/cdstrProduto", (req, res) => {
    res.send(`
        ...
        <div class="container">
            ...
            <form method="POST" action="/chcrProduto" class="row g-3 needs-validation m-3 p-3 bg-light" novalidate>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" class="form-control" id="preco" aria-describedby="inputGroupPrepend">
                    </div>
                </div>
                <div class="col-md-6">
